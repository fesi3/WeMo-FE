...
const StatisticsCard = ({ user }: UserProps) => {
  ...
  const statistics = [
    { text: '이용 예정', value: joinedPlanCount, href: '/app/user/plan' },
    { text: '찜한 일정', value: likedPlanCount, href: '/app/saved-gathering' },
    { text: '작성 리뷰', value: writtenReviewCount, href: '/app/user/review' },
  ];
